...
export default function Home() {
  ...
  return <main>
    ...
    {view==="home"&&<>
      <section className="hero"><div className="hero-copy"><p className="kicker">B7 PERFORMANCE SYSTEM</p><h1>RESULTADO<br/>NÃO É ACASO.</h1><p>Suplementação, avaliação corporal e acompanhamento personalizado em uma única experiência.</p><div><button className="solid" onClick={()=>go("catalog")}>COMPRAR AGORA</button><button className="outline" onClick={account}>ACESSAR MEU PAINEL</button></div></div><div className="hero-art"><span>07</span><div className="hero-can"><small>B7</small><b>PURE<br/>CREATINE</b><em>300 G</em></div><p>FORÇA. FOCO.<br/>CONSISTÊNCIA.</p></div></section>
