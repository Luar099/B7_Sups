...
const makeDemoData = (role:Role="admin"):Data => ({
  ...
  products:[
    {id:1,name:"Creatina Monohidratada",brand:"B7 PURE",category:"Creatina",description:"Força, potência e recuperação.",size:"300 g · sem sabor",price:89.9,oldPrice:129.9,stock:36,badge:"-31%",imageUrl:"./og.png",active:true},
